...
Код для продвинутого тестирования Android Kotlin Codelab 5.1-5.3
...
TO-DO Notes-это приложение, в котором вы записываете задачи для выполнения. Приложение отображает их в виде списка.
Затем вы можете пометить их как завершенные или нет, отфильтровать и удалить.

![App main screen, screenshot](screenshot.png)

This codelab has four branches, representing different code states:
Эта кодовая вкладка имеет четыре ветви, представляющие различные состояния кода:
...
Кодовые таблицы в этой серии следующие:
