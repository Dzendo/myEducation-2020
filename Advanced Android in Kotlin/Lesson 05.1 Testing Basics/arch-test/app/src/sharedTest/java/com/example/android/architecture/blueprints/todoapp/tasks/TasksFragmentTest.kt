...
// cmp=org.robolectric.default/com.example.android.architecture.blueprints.todoapp.tasks.TasksActivity }
...
// java.lang.RuntimeException: Unable to resolve activity for Intent
// { act=android.intent.action.MAIN cat=[android.intent.category.LAUNCHER]
// cmp=org.robolectric.default/androidx.fragment.app.testing.FragmentScenario$EmptyFragmentActivity (has extras) }
// -- see https://github.com/robolectric/robolectric/pull/4736 for details
