...
import com.example.android.guessworld.databinding.GameFragmentBinding
...
class GameFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
       ...
       /* binding = DataBindingUtil.inflate( ***альтернативный вариант ниже***
                inflater,
...
// *  без ViewModelProvider будет создаваться кажкый раз НОВЫЙ экземпляр что не надо
       ...
       // viewModel = ViewModelProvider(this).get(GameViewModel::class.java)
        ...
        // Переделано на объявление схерху viewModel: GameViewModel by viewModels() это сразу все
       ...
       // binding.lifecycleOwner = viewLifecycleOwner // Udacity
        binding.lifecycleOwner = viewLifecycleOwner // Codelabs //  - Владелец цикла жизни Я this
