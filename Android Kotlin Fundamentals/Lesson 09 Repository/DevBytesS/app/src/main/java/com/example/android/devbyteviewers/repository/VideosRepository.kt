...
package com.example.android.devbyteviewers.repository
...
import com.example.android.devbyteviewers.database.VideosDatabase
import com.example.android.devbyteviewers.database.asDomainModel
import com.example.android.devbyteviewers.domain.DevByteVideo
import com.example.android.devbyteviewers.network.DevByteNetwork
import com.example.android.devbyteviewers.network.asDatabaseModel
...
// за возвращенным LiveData свойством.
    ...
    // Таким образом, вам нужно преобразовать список DatabaseVideoв список Video.
