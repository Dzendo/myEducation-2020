 ...
 * Это единственное приложение активности, которое использует навигационную библиотеку.
 * Содержимое отображается фрагментами.
 */
class DevByteActivity : AppCompatActivity() {
     ...
     * Вызывается, когда действие начинается.
     * Именно сюда должна идти большая часть инициализации
     */
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        //setContentView(ActivityDevByteViewerBinding.inflate(LayoutInflater.from(applicationContext)).root)
