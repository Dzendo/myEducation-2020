 ...
 * Доменные объекты-это простые классы данных Kotlin, которые представляют вещи в нашем приложении.
 * Это объекты, которые должны отображаться на экране или управляться приложением.
 *
 ...
 */
// DevByteVideo класс данных в domain/Models.kt классе представляет одно видео DevByte.
