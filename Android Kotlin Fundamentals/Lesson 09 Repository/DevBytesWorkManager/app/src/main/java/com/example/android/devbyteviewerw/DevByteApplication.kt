...
package com.example.android.devbyteviewerw

import android.app.Application
import android.os.Build
import androidx.work.*

import com.example.android.devbyteviewerw.work.RefreshDataWorker
...
class DevByteApplication : Application() {
    ...
    private fun setupRecurringWork() {
        ...
        //WorkManager.getInstance().enqueueUniquePeriodicWork(  // AS new androidx.work:work-runtime-ktx
