...
/*
Так почему RecyclerViewбы просто не использовать TextView напрямую?
...
/*
Если RecyclerViewн еобходимо получить доступ к представлениям, хранящимся в ViewHolder,
