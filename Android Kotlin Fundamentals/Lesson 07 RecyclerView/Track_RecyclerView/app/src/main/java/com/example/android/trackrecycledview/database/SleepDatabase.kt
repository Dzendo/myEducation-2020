...
package com.example.android.trackrecycledview.database
 ...
 * так что вы можете использовать его повторно.
 */
...
abstract class SleepDatabase : RoomDatabase() {
    ...
    companion object {
         ...
         *  Значение переменной volatile никогда не будет кэшироваться, а все записи и записи будут выполняться автоматически.
         * чтение будет выполняться в основную память и из нее. Это означает, что изменения, внесенные одним человеком
         ...
         * Контекст приложения Синглтон, используемый для получения доступа к файловой системе.
         */
