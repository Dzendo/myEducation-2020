 ...
 * Действия, содержащие этот фрагмент, должны реализовывать следующее:
 * [SleepDetailFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * интерфейс для обработки событий взаимодействия.
 * Use the [SleepDetailFragment.newInstance] factory method to
 * create an instance of this fragment.
 * фабричный метод к созданию экземпляра этого фрагмента.
 *
 */
