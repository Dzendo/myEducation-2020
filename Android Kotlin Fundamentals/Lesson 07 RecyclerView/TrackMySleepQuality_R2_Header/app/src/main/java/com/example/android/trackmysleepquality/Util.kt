 ...
 * Преобразуйте длительность в форматированную строку для отображения.
 *
 * Examples:
 *
 ...
 * и преобразовать его в красиво отформатированную строку для отображения.
 *
 ...
 * Для отображения в текстовом представлении мы должны предоставить одну строку, а стили-на текстовое представление, а не на текстовое представление.
 * применимо для каждого слова. Итак, мы создаем форматированную строку с помощью HTML. Это удобно, но мы будем
