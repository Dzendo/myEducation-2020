 ...
 * Определяет методы для использования класса Sleep Night с комнатой.
 */
@Dao
interface SleepDatabaseDao {
     ...
     * Выбирает и возвращает строку, соответствующую предоставленному времени начала, которое является нашим ключом.
     *
     ...
     * Удаляет все значения из таблицы. При этом таблица не удаляется, а только ее содержимое.
     */
