...
class PlantListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        context ?: return binding.root  // ?? когда это
        binding.viewModel = viewModel
        binding.lifecycleOwner = this

        // show the spinner when [spinner] is true
        // показать счетчик, когда [spinner] имеет значение true
        // перенес в XML
        ...
        // Показывать закусочную всякий раз, когда [закусочная] обновляется ненулевым значением
...
// 10,чтобы она указывала на наш новый plantsUsingFlow LiveData.
 ...
 * Фабрика для создания [Plant List ViewModel] с конструктором, который принимает [Plant Repository].
 */
