...
class SleepTrackerViewModel(
    ...
    // Получить все ночи из базы данных и назначить их для nights переменной для наблюдения.
    ...
    fun onStopTracking() {
        uiScope.launch {
            ...
            update(oldNight) // Это функция см ниже
            _navigateToSleepQuality.value = oldNight   //
            // Когда эта переменная имеет значение, приложение переходит к SleepQualityFragment, минуя ночь.
        }
    }
