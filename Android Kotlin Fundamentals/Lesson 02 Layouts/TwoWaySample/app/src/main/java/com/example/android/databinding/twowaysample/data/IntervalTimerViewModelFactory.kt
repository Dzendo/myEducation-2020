 ...
 * Фабрики для создания/подхвата ViewModel нужен т.к. IntervalTimerViewModel(DefaultTimer) с параметром
 * В util/TimerWrapper.kt лежит DefaultTimer с интерфейсом Timer
 * остальное стандарт
 */
