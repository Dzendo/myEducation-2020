...
class PlainOldActivitySolution4 : AppCompatActivity() {
    ...
    private val viewModel by lazy {
        ...
        // Перешли на окончательную модель
    }
...
/*
Есть несколько способов реализации наблюдаемости.
Вы можете использовать наблюдаемые классы , наблюдаемые поля или, предпочтительно, LiveData .
Полная документация по этому вопросу здесь .
 */

// Ставим наблюдение за Моделью
        // Мы будем использовать ObservableFields, так как они проще:
