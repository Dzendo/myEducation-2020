 ...
 * Показывает главный экран заголовка.
 * Стоит на Тривиальном XML с самыми обычными двумя кнопками
 * Еще там тект и картинка статичные + Theme.AppCompat.Light.DarkActionBar" из манифеста
 */
