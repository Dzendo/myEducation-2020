...
package com.example.android.guessthewordr.screens.title
...
import com.example.android.guessthewordr.databinding.TitleFragmentBinding
...
class TitleFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding.playGameButton.setOnClickListener {
            ...
            // берет вроде из main_navigation.xml android:id="@+id/action_title_to_game"
            // точнее из сгенерированного binding
