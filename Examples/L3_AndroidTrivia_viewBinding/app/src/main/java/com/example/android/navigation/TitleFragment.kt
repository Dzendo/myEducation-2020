...
/**
 * Стартовый фрагмент ViewBinding Внизу разные варианты
 * Menu ...
 */
class TitleFragment : Fragment() {
    ...
    // overflow_menu - Заполнение меню ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        super.onCreateOptionsMenu(menu, inflater)
        inflater.inflate(R.menu.options_menu, menu)
    }
    // обработка выбора меню ... не требуется указывать переход - контроллер сам перейдет по имени
...
class TitleFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
       ...
       // return inflater.inflate(R.layout.fragment_title, container, false)
        ...
        //        R.layout.fragment_title,container,false) // для датабиндинга через layout:
        val binding = FragmentTitleBinding.inflate(inflater)  // viewBinding = true без layout
