...
import com.example.android.guessworld.databinding.ScoreFragmentBinding
...
class ScoreFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding  = ScoreFragmentBinding.inflate(
                inflater,
        ...
        // Найти способ создавать с параметром через by см вначале
        // Передайте окончательный результат из набора аргументов в качестве параметра конструктора для ScoreViewModelFactory().
        // viewModelFactory = ScoreViewModelFactory(<final score here>) из Udacity
       ...
       // viewModelFactory = ScoreViewModelFactory(ScoreFragmentArgs.fromBundle(arguments!!).score)
        ...
        binding.lifecycleOwner = viewLifecycleOwner  // встроенная функцтя фрагмента - Владелец цикла жизни Я
