...
import com.example.android.gdgfinders.network.GdgApi
...
class GdgListViewModel: ViewModel() {
    ...
    private fun onQueryChanged() {  // если выполняется предыдущий запрос, отмените его перед запуском другого
        ...
        currentJob = viewModelScope.launch {
            try {
                ...
                repository.getFilters().let {
                    ...
                    // обновляйте список фильтров только в том случае, если он изменился с прошлого раза
