...
import com.example.android.gdgfinders.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupNavigation()
        // 1. Измените тему на DayNight.
        // В styles.xmlизмените AppTheme parentтему с Lightна DayNight:
     ...
     * Настройка навигации для этого действия
     */
    private fun setupNavigation() {
        // first find the nav controller
        // сначала найдите навигационный контроллер
        val navController = findNavController(R.id.nav_host_fragment)

        setSupportActionBar(binding.toolbar)

        // then setup the action bar, tell it about the DrawerLayout
        // затем настройте панель действий, расскажите ей о DrawerLayout
