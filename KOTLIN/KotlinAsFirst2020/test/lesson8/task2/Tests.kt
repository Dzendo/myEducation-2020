...
class Tests {
    ...
    @Test
    @Tag("Easy")
    fun square() {   // нет проверки на недопустимое типа d0 d9 z5 zz
    ...
    fun bishopTrajectory() {
        ...
        assertEquals(listOf(square("f2"), square("d4"), square("b2")), bishopTrajectory(square("f2"), square("b2")))
        assertEquals(listOf(square("c8"), square("e6"), square("g8")), bishopTrajectory(square("c8"), square("g8")))
    }
