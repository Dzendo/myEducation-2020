...
class Tests {
    ...
    fun bisectorByPoints() {
        ...
        assertApproxEquals(Line(Point(1.0, 1.0), PI / 4), bisectorByPoints(Point(0.0, 2.0), Point(2.0, 0.0)))
        assertApproxEquals(Line(Point(2.5, 2.5), PI * 3 / 4), bisectorByPoints(Point(0.0, 0.0), Point(5.0, 5.0)))
    }
