...
class HexTests {
    ...
    fun hexPointDistance() {
        ...
        assertEquals(5, HexPoint(1, 4).distance(HexPoint(6, 4)))
        assertEquals(5, HexPoint(4, 1).distance(HexPoint(4, 6)))
        assertEquals(6, HexPoint(7, 1).distance(HexPoint(1, 5)))
        assertEquals(8, HexPoint(8, 0).distance(HexPoint(0, 6)))
        assertEquals(8, HexPoint(3, 0).distance(HexPoint(5, 6)))
        assertEquals(8, HexPoint(0, 5).distance(HexPoint(8, 0)))
        assertEquals(8, HexPoint(6, 5).distance(HexPoint(2, 1)))
        assertEquals(4, HexPoint(1, 5).distance(HexPoint(5, 5)))
        assertEquals(4, HexPoint(4, 1).distance(HexPoint(4, 5)))
    }
    ...
    fun hexagonContains() {
        ...
        assertTrue(Hexagon(HexPoint(6, 3), 2).contains(HexPoint(6, 1)))
        assertFalse(Hexagon(HexPoint(6, 3), 2).contains(HexPoint(4, 1)))
    }

    // Написать Тесты для angles() sides() kontur()  ????
