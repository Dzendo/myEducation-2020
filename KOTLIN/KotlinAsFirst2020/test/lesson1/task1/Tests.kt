...
// Большинство классов этой библиотеки находятся в пакете org.junit для версии JUnit 4.x
// или в пакете org.junit.jupiter.api для версии JUnit 5.х.
...
class Tests {
    // @Test — это так называемая аннотация,
    // то есть, пометка, используемая для придания функции testSqr дополнительного смысла
    @Test
    @Tag("Example")
    fun sqr() {
