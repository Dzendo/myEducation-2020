...
class PolynomTest {
    ...
    fun getValue() {
        ...
        val p1 = Polynom(0.0, 0.0, 5.0, 3.0)
        assertEquals(18.0, p1.getValue(3.0), 1e-10)
        val p2 = Polynom(0.0, 3.0, 0.0, 5.0, 0.0)
        assertEquals(-34.0, p2.getValue(-2.0), 1e-10)
    }
    ...
    fun equals() {
        ...
        assertEquals(Polynom(2.0, 3.0), Polynom(2.0, 3.0))
