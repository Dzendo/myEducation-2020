...
class DimensionalValue(value: Double, dimension: String) : Comparable<DimensionalValue> {
    ...
    init {
      //  println("_value= $_value _dimension= $_dimension _dimension.length= ${_dimension.length}  _dimension[0] = ${_dimension[0]}")
        ...
        baseDimension1 = Dimension.GRAM


       // println(" dimDivision =$dimDivision baseDimension=$baseDimension preDimension=$preDimension")
       println("Dimension = $baseDimension1  name=${baseDimension1.name} value=  ${baseDimension1.abbreviation}")
    }
     ...
     */
    operator fun unaryMinus(): DimensionalValue = DimensionalValue(-this._value, this.dimension.abbreviation)
